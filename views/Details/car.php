...
<div class="flex justify-center align-middle flex-row gap-x-6">
    ...
    <div>
        ...
        <button class="p-4 rounded-lg mt-8 text-white font-bold" onclick="location.href='../Edit/cars.php?idVoiture=<?php echo $voiture->getImmatriculation()?>'" style="background: #f4a261"  ><svg width="24px" viewBox="0 0 20 20"><path d="m12.3 3.7 4 4L4 20H0v-4L12.3 3.7zm1.4-1.4L16 0l4 4-2.3 2.3-4-4z" fill="#ffffff" class="fill-000000"/></svg></button>
