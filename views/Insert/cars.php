...
<div class="flex align-middle justify-center flex-col w-full items-center">
    ...
    <form style="width: 66%" class="flex justify-center flex-col" action="waiting_car.php" method="post">
        ...
        <select name="idModele" class="mb-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            <?php
        ...
        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 ">Kilométrage</label>
