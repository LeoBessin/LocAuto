...
<div class="flex align-middle justify-center flex-col w-full items-center">
    ...
    <form style="width: 66%" class="flex justify-center flex-col" action="waiting_car.php" method="post">
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-8">Enregistrer une nouvelle voiture</button>
    </form>
