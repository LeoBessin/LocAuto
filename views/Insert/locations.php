...
<div class="flex align-middle justify-center flex-col w-full items-center">
    ...
    <form style="width: 66%" class="flex justify-center flex-col" action="waiting_location.php" method="post">
        ...
        <input type="date" id="date-debut" name="date-debut" class="mb-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" min="<?php echo $dateTodayFormat?>" required>

        <label for="date-fin" class="block mb-2 text-sm font-medium text-gray-900 ">Date Fin</label>
        <input id="date-fin" class="mb-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name="date-fin" type="date" min="<?php echo $dateTodayFormat?>" required>
        ...
        <div class="flex items-start mb-8 flex flex-col">
            ...
            <div class="mb-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                ...
                <p>Prix de la catégorie : <span id="categoriePrix"><?php echo $categorie->getPrix()?></span>€</p>
