...
<div class="flex align-middle justify-center flex-col w-full items-center">
    ...
    <form style="width: 66%" class="flex justify-center flex-col" action="waiting_location.php" method="post">
        <input type="hidden" name="id" aria-label="disabled input 2" class="mb-8 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" value="<?= $lastLocation==null ? 1 : $lastLocation->getId()+1 ?>" readonly>
