...
<th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">' .
    ...
    ?>
    <a class="self-center mb-12 p-4 rounded-lg mt-8 text-white font-bold w-1/6 flex flex-row justify-center align-middle" style="background: #EF476F" href="../Delete/clients.php?idClient=<?php echo $client->getId(); ?>" >Supprimer</a>
