...
<div class="flex flex-wrap flex-row z-10">
    ...
    foreach ($allVoiture as $voiture) {
        ...
        echo '<button onclick="change_side_bar_state()">';
    ...
    <button onclick="location.href='../../views/Insert/cars.php'">
<?php
    echo '<div class="px-6 py-4 flex flex-col hover:cursor-pointer mt-6 hover:scale-110">
